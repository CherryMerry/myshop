...
<div class="container">
	...
	<div>
		<h1 class="page-header">添加商品品牌</h1>
		<form action="__URL__/insert" method="post" enctype="multipart/form-data">
            ...
            <input type="hidden" id="imgUrl" name="logo" value="">
			...
			<div class="form-group">
				...
				<select name="class_id" id="">
					...
					<?php if(is_array($classrows)): $i = 0; $__LIST__ = $classrows;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$classrow): $mod = ($i % 2 );++$i;?><option value='<?php echo ($classrow['id']); ?>'><?php echo ($classrow['name']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
				</select>	
			</div>
